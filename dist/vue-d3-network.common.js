...
/* harmony default export */ var svgRenderervue_type_script_lang_js_ = ({
  ...
  methods: {
    renderAxis: function renderAxis() {
      ...
      src_select('.y-axis').call(axisLeft(this.yScale).ticks(4).tickFormat(function (d) {
        return _this.legends.length > 0 ? "".concat((d / _this.legends.length * 100).toFixed(), " %") : d;
      }));
    },
