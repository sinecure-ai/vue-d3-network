...
// CONCATENATED MODULE: ./src/components/svgRenderer.vue?vue&type=template&id=68ecb371&lang=pug&
...
/* harmony default export */ var svgRenderervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    mouseover: function mouseover(e, node) {
      ...
      this.tooltipy = "".concat(e.pageY, "px");
      this.tooltipx = "".concat(e.pageX, "px");
