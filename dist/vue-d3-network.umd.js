...
/* harmony default export */ var svgRenderervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    xScale: function xScale() {
      return src_linear_linear().range([50, this.size.w]).domain([0, 10]);
    }
  },
