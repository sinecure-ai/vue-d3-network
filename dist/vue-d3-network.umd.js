...
/* harmony default export */ var vue_d3_networkvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    yScale: function yScale() {
      return src_linear_linear().range([this.size.h, 200]).domain([0, this.legends.length]);
    },
    xScale: function xScale() {
      return src_linear_linear().range([this.size.w, 200]).domain([0, 10]);
    }
  },
  watch: {
